...
export class DefaultRoles1681072109943 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    prospective_member.role_description =
      "- A student who is not yet a member.";
    ...
    alumni.role_description =
      "- One who was previously a member of the club, but graduated or otherwise left.";
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    const alumni = new MemberRole();
    alumni.role_name = "Alumni";
    queryRunner.manager.delete(MemberRole, [
      dbDev,
      president,
      vice_president,
      secretary,
